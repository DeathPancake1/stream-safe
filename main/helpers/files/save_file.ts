...
export default async function writeFile (event, user1Email, user2Email, fileName, jwt, url, apiKey, path)  {
    ...
    const outputFilePath = join(streamSafePath, 'videos', user1Email + '_' + user2Email);
